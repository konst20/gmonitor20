...
class Gearman_Db extends G_Db{
    ...
    public function __construct(){
        ...
        $this->db_host = Gmonitor_Settings::$db_host;
        $this->db_name = Gmonitor_Settings::$db_name;
        $this->db_user = Gmonitor_Settings::$db_user;
        $this->db_pass = Gmonitor_Settings::$db_pass;
